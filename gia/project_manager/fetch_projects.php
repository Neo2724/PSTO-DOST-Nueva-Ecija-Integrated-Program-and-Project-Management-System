...
$query = "SELECT id, name, year, status FROM gia_projects"; // ✅ Ensure status is selected
...
while ($row = $result->fetch_assoc()) {
    ...
    $fileQuery = "SELECT COUNT(*) AS uploadedCount FROM gia_files WHERE project_id = ? AND uploaded = 1";
