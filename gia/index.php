<?php
session_start();
if (!isset($_SESSION['user']) || $_SESSION['system'] !== 'gia') {
...
<head>
    ...
    <title>GIA System - DOST Nueva Ecija</title>
    ...
    <div class="system-container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/GIA-O6U2qOGovmvy9WCLdnuYarwp7YY5GD.png" alt="CEST Logo" class="system-logo">
                <h2>GIA System</h2>
            </div>
            <nav>
...
<script>//files forms template
    ...
    function fetchFiles() {
        fetch('http://localhost/dostphp/gia/list_files.php') // Ensure the PHP script is in the correct directory
